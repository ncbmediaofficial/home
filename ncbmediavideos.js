 document.addEventListener('DOMContentLoaded', function() {
            ...
            const likeButtons = document.querySelectorAll('.post-action[data-likes]');
     ...
     const filterButtons = document.querySelectorAll('.filter-btn');
            const videoCards = document.querySelectorAll('.shatta-video-card');
            ...
            const shattaVideos = document.querySelectorAll('.shatta-video-player');
            shattaVideos.forEach(video => {
